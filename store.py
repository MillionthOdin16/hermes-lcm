...
class MessageStore:
    ...
    def _append_protected_batch(self, session_id: str,
        ...
        for i, (msg, est) in enumerate(zip(messages, token_estimates)):
            ...
            # ⚡ Bolt Optimization: Apply offset to ensure strictly unique timestamps
            ts = base_ts + (i * 1e-6)
            params.append((
                session_id,
                norm_source,
        ...
        with self._write_lock, self._conn:
            # ⚡ Bolt Optimization: Use executemany for faster batch inserts
            ...
            # Retrieve last insert ID and calculate previous ones
