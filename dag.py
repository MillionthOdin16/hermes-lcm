    ...
    def _search_like(self, query: str, session_id: str | None = None,
        ...
        while True:
            ...
            for row in rows:
                ...
                score = sum(
                    min(count_term_matches(lowered_summary, l_term, is_lowered=True), 1) if collapse_risky_repeats else count_term_matches(lowered_summary, l_term, is_lowered=True)
