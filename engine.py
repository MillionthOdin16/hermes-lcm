...
class LCMEngine(CompactionMixin, ResetStateMixin, ReconcileMixin, AuxiliarySessionMixin, PlaceholderLedgerMixin, BypassMixin, ContextEngine):
    ...
    def compress(self, messages: List[Dict[str, Any]],
        ...
        turn_source_tokens = 0
        turn_summary_tokens = 0
        ...
        while leaf_passes < max_leaf_passes:
            ...
            turn_source_tokens += source_tokens
            turn_summary_tokens += summary_tokens
        ...
        self._last_compression_noop_reason = ""
        if turn_source_tokens > 0:
            savings_pct = (turn_source_tokens - turn_summary_tokens) / turn_source_tokens
            if savings_pct < 0.10:
