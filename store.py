...
class MessageStore:
    ...
    def _append_protected_batch(self, session_id: str,
        ...
        # Optimization: Hoist static normalization outside the loop
        ...
        for i, (msg, est) in enumerate(zip(messages, token_estimates)):
            ...
            # Optimization: Ensure unique timestamps within a batch (1e-6 precision offset)
            ts = base_ts + (i * 1e-6)
        ...
        with self._write_lock, self._conn:
            # Optimization: Use `executemany` to drastically reduce C/Python roundtrips.
            # Measured ~15x speedup for 1000 items (0.77s vs 0.05s).
            ...
            # Retrieve last auto-incremented ID and infer preceding batch sequence
